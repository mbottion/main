...
repositoriesList="SQLTools ASMTools DGTools TDETools SHELLTools CTools"  # List of common repositories (for those repos, the file name is sufficient to run a file
