...
repositoriesList="SQLTools SHELLTools ASMTools DGTools TDETools BACKUP Tools MTools CTools RMANTools"  # List of common repositories (for those repos, the file name is sufficient to run a file
